...
The purpose of the project is to start traveling from our starting position to first 'n' cities. 
Then we will go back to our starting position without revisiting any of our previous cities. 
We are calculating every possible total km result and comparing each of them and selecting the best one.
